...
class Page extends DefaultPage
{
	function generate_breadcrumb()
	{
		...
		{
			if(isset($this->breadcrumb_trail[$key+1]))
			{
				$trail .= "<a href=\"".$crumb['url']."\">".$crumb['name']."</a>";
				if(isset($this->breadcrumb_trail[$key+2]))
				{
					$trail .= " &raquo; ";
				}
			}
...
EOF;
	...
	function output_footer($quit=true)
	{
		...
		echo "<div id=\"footer\"><p class=\"generation\">".$lang->sprintf($lang->generated_in, $totaltime, $debuglink, $querycount, $memory_usage)."</p><p class=\"powered\">Powered By <a href=\"https://www.mybb.com/\" target=\"_blank\">MyBB</a>, &copy; 2002-".COPY_YEAR." <a href=\"https://www.mybb.com/\" target=\"_blank\">MyBB Group</a> All Rights Reserved.&nbsp;&nbsp;Style \"Sharepoint8\" ported by <a href=\"https://github.com/vintagedaddyo/MyBB_ACP_Style_Sharepoint8\" target=\"_blank\"><b>Vintagedaddyo</b></a>.</p></div>\n";
		if($mybb->debug_mode)
		{
			echo $db->explain;
		}
